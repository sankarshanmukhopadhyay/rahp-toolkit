...
def build_result(args: argparse.Namespace) -> tuple[dict[str, Any], str]:
    ...
    repos = {
        "rahp": {"path": str(rahp), "revision": git_head(rahp), "clean": git_clean(rahp)},
    ...
    if not all(v["clean"] for v in repos.values()):
        raise RuntimeError("clean-room precondition failed: one or more worktrees are dirty")
    ...
    result = {
        ...
        "deterministic_stages": {
            ...
            "rahp_scaffold_capability": "AVAILABLE",
