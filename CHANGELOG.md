...
v2.0.0 **Blue Mormon** and the complete earlier release history remain immutable in Git history and release tags. Historical release-note files remain under [`docs/releases/`](docs/releases/), and pre-v1.2 accumulated history remains under `archive/pre-v1.2/`.
